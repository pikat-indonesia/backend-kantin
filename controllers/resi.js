...
exports.getResi = (req, res) => {
  ...
  let sql =
    ...
    idKantin +
    "' AND (DATE(tbl_resi.date) >= CURDATE() AND DATE(tbl_resi.date) <= CURDATE()) GROUP BY tbl_resi.id,tbl_resi.table_type,tbl_resi.cost,tbl_resi.pay,tbl_resi.change,tbl_resi.date;";
...
exports.countCost = (req, res) => {
  const idKantin = req.body.idKantin;
  let sql =
    "SELECT SUM(cost) AS total_income FROM tbl_resi WHERE idKantin = '" +
    idKantin +
...
exports.countBarang = (req, res) => {
  const idKantin = req.body.idKantin;
  let sql =
    "SELECT COUNT(*) AS total_count FROM tbl_resi WHERE idKantin = '" +
    idKantin +
    "' AND DATE(tbl_resi.date) = CURDATE();";
